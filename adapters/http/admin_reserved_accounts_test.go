...
func TestHandleOwnerNamespaceInfoGET_InvalidRequest(t *testing.T) {
	...
	r := httptest.NewRequest(http.MethodGet, "/owners/", nil)
...
func TestHandleAdminAccountParkPOST_InvalidRequest(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/account/park", strings.NewReader(`{}`))
...
func TestHandleAdminAccountClaimPOST_InvalidRequest(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/account/claim", strings.NewReader(`{}`))
	r.Header.Set("Content-Type", "application/json")
...
func TestHandleAdminAccountClaimPOST_RequiresOwnerUserIDForOrgKind(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/account/claim", strings.NewReader(`{"kind":"org","slug":"google"}`))
	r.Header.Set("Content-Type", "application/json")
...
func TestHandleAdminAccountParkPOST_RejectsUnknownKind(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/account/park", strings.NewReader(`{"kind":"team","slug":"google"}`))
	r.Header.Set("Content-Type", "application/json")
...
func TestHandleAdminAccountsRestrictPOST_InvalidRequest(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/accounts/restrict", strings.NewReader(`{}`))
	r.Header.Set("Content-Type", "application/json")
...
func TestHandleAdminAccountsRestrictPOST_RequiresNonEmptySlugs(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/accounts/restrict", strings.NewReader(`{"slugs":[]}`))
	r.Header.Set("Content-Type", "application/json")
...
func TestHandleAdminAccountsUnrestrictPOST_InvalidRequest(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/accounts/unrestrict", strings.NewReader(`{}`))
	r.Header.Set("Content-Type", "application/json")
...
func TestHandleAdminAccountsUnrestrictPOST_RequiresNonEmptySlugs(t *testing.T) {
	...
	s := newTestService(t)
	w := httptest.NewRecorder()
	r := httptest.NewRequest(http.MethodPost, "/admin/accounts/unrestrict", strings.NewReader(`{"slugs":[]}`))
	r.Header.Set("Content-Type", "application/json")
