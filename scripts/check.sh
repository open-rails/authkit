...
required = {
    'securitytest': ('TestSecurityAccessTokenForgery', 'TestSecurityBearerTransport',
                     ...
                     'TestSecurityAccountEnumeration', 'TestSecurityUnprovenContactCannotAddLoginMethods',
                     'TestSecurityPreRegistrationTakeover', 'TestSecurityRegistrationNeverSelfVerifies',
                     'TestSecurityProviderEmailTrust', 'TestSecurityPasswordLimitIsPerAddress',
                     'TestSecurityDemotedCreatorCredentials', 'TestSecurityRevokeAboveOwnRole',
                     'TestSecurityRemoteApplicationIssuerSquat', 'TestSecurityDelegatedGrantClamp',
                     'TestSecurityIssuerWithoutAudience', 'TestSecurityOIDCStateCookieIsHostPrefixed',
