...
var errorsByCode = func() map[string]error {
	all := []error{
		...
		ErrAccountRegistrationInviteEmailMismatch, ErrAccountRegistrationInviteExpired,
		ErrAccountRegistrationInviteNotFound, ErrAccountRegistrationInviteRevoked, ErrCustomClaimsReserved,
