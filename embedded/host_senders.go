...
func (s *Runtime) HasEmailSender() bool { return s.email != nil }

// HasSMSSender returns true if an SMS sender is configured.
func (s *Runtime) HasSMSSender() bool { return s.sms != nil }
...
func (s *Runtime) CheckSMSHealth(ctx context.Context) error {
	if s == nil {
		return nil
	}
...
func (s *Runtime) SMSHealthy() bool { return s != nil && s.smsHealth.available() }
...
func (s *Runtime) SMSAvailable() bool {
...
func (s *Runtime) ValidateVerificationConfiguration() error {
	if s == nil {
		return nil
	}
...
// 15s when unset.
func (s *Runtime) verificationSendTimeout() time.Duration {
...
// calling function.
func (s *Runtime) withSendTimeout(ctx context.Context, send func(context.Context) error) error {
