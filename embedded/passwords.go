...
func (s *Runtime) authenticatePassword(ctx context.Context, u *User, pass string) (int64, error) {
	if s.pg == nil {
...
func (s *Runtime) CheckUserPassword(ctx context.Context, userID, pass string) error {
...
func (s *Runtime) rehashPassword(ctx context.Context, userID, hash, algo, pass string) {
	if algo != "bcrypt" {
		return
	}
...
func (s *Runtime) ChangePassword(ctx context.Context, userID, current, new string, keepSessionID *string) error {
...
func (s *Runtime) SetPasswordAfterFreshAuth(ctx context.Context, userID, new string, keepSessionID *string) error {
