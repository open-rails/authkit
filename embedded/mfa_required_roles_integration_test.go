...
func TestRequireMFAEnrollmentForcesEnrollment(t *testing.T) {
	...
	lenient := mustNewWithKeys(t, Config{Token: TokenConfig{Issuer: "https://test"}}, Keyset{}, WithPostgres(pool))
	...
	strict := mustNewWithKeys(t, Config{Token: TokenConfig{Issuer: "https://test"}, TwoFactor: TwoFactorConfig{Mode: TwoFactorRequired}}, Keyset{}, WithPostgres(pool))
