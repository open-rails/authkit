...
func (s *Runtime) MayCreateInstance(ctx context.Context, group authkit.GroupRef, subject string) error {
...
func (s *Runtime) CreateInstanceForSubject(ctx context.Context, group authkit.GroupRef, displayName, ownerUserID string) (CreateInstanceResult, error) {
...
// claimable.
func (s *Runtime) authorizeSlugClaim(ctx context.Context, sch *GroupSchema, group authkit.GroupRef, actorUserID string) error {
	persona, slug := group.Persona, group.Instance
...
func (s *Runtime) userHoldsRootRole(ctx context.Context, userID string, role authkit.Role) bool {
...
func (s *Runtime) subjectMemberOfGroup(ctx context.Context, userID string, group authkit.GroupRef) (string, bool, error) {
...
func (s *Runtime) AssignRemoteApplicationRoleAs(ctx context.Context, actorUserID string, group authkit.GroupRef, appSlug string, role authkit.Role) error {
