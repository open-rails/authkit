...
func (s *Client) lockAuthority(ctx context.Context, q db.DBTX) error {
...
func (s *Client) refuseOwnerLoss(ctx context.Context, st *PermissionGroupStore, gid string, subject authkit.Subject) error {
...
func (s *Client) refuseSubjectOwnerLoss(ctx context.Context, st *PermissionGroupStore, subject authkit.Subject) error {
	table, column, err := groupRoleTable(subject.Kind)
	if err != nil {
		return err
	}
...
func (s *Client) assignInvitedRole(ctx context.Context, st *PermissionGroupStore, gid string, persona authkit.Persona, userID string, role authkit.Role) error {
