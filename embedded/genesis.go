...
// Runtime callers use AssignRoleBySlugAs.
...
// check and NO no-escalation enforcement. Bootstrap/migration only — see
// GenesisClient. Runtime callers use AssignGroupRoleAs.
