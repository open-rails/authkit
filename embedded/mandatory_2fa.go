...
func (s *engine) MFAStatusWith(settings *TwoFactorSettings, settingsErr error) (MFAStatus, error) {
...
func (s *engine) requireSessionMFAStateWith(ctx context.Context, userID string, authMethods []string, status MFAStatus, statusErr error) error {
	return s.requireSessionMFAStateOn(ctx, s.pg, userID, authMethods, status, statusErr)
}

func (s *engine) requireSessionMFAStateOn(ctx context.Context, q db.DBTX, userID string, authMethods []string, status MFAStatus, statusErr error) error {
