...
type PasswordlessConfirmResult = authcore.PasswordlessConfirmResult
type PasswordlessStartRequest = authcore.PasswordlessStartRequest
type PasswordlessStartResult = authcore.PasswordlessStartResult
...
var ErrPasswordlessDisabled = authcore.ErrPasswordlessDisabled
