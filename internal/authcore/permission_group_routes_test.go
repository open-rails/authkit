...
func TestGeneratedRoutes_SurfaceMirrorsProfile(t *testing.T) {
	...
	if !has("merchant", "POST", "/merchant/:resource_slug/members") {
		t.Errorf("merchant member-assignment route missing")
	}
	if !has("merchant", "POST", "/merchant/:resource_slug/api-keys") {
...
func TestGeneratedRoutes_GatesAreCorrect(t *testing.T) {
	...
	want := map[string]string{ // "METHOD path" -> gate perm
		"POST /org/:resource_slug/members":             "org:members:manage",
		"GET /org/:resource_slug/members":              "org:members:read",
		"POST /org/:resource_slug/roles":               "org:roles:manage",
		"GET /org/:resource_slug/roles":                "org:roles:read",
		"POST /org/:resource_slug/api-keys":            "org:api-keys:manage",
		"POST /org/:resource_slug/remote-applications": "org:remote-apps:manage",
		"POST /org/:resource_slug/invites":             "org:invites:manage",
	}
