...
func TestRequireMFAEnrollmentForcesEnrollment(t *testing.T) {
	...
	lenient := mustNewService(t, Config{Token: TokenConfig{Issuer: "https://test"}}, Keyset{}, WithPostgres(pool))
	...
	strict := mustNewService(t, Config{Token: TokenConfig{Issuer: "https://test"}, TwoFactor: TwoFactorConfig{Mode: TwoFactorRequired}}, Keyset{}, WithPostgres(pool))
