...
- Admin owner-namespace lifecycle (admin only):
  ...
  - POST /auth/admin/org/park
  - POST /auth/admin/org/claim (requires `owner_user_id`; claims parked orgs, creates+claims missing orgs, and rejects already-claimed orgs)
