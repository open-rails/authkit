...
// the Verifier's JWKS fetches (the issuer/JWKS URL can come from org-issuer
// federation data) and the org-issuer registration POST. Without a timeout a
...
// does not inject its own via WithHTTPClient / WithOrgIssuersHTTPClient.
